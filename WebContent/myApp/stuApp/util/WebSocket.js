...
Ext.define ('core.util.WebSocket', {
	...
	initWebsocket: function () {
		...
		if ('WebSocket' in window) {  
           // alert("WebSocket");  
            me.url=WinsocketUrl;
           me.ws = new WebSocket(WinsocketUrl);  
            //websocket = new WebSocket("ws://127.0.0.1:8080/SSMTest/echo");  
        } else if ('MozWebSocket' in window) {  
          //  alert("MozWebSocket");  
            me.ws= new MozWebSocket("ws://"+MozWebSocketUrl); 
            me.url="ws://"+MozWebSocketUrl;
        } else {  
           // alert("SockJS");  
           me.ws = new SockJS(SockJSUrl);  
           me.url=SockJSUrl;
        }  
